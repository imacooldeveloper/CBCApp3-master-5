//
//  InvestigatorLoginController.swift
//  CBCApp3
//
...
class InvestigatorLoginController: UIViewController {
...
//        guard let floor = floorNum.text, floor.count > 0 else { return }
        ...
        let investigatorController = InvestigatorController(collectionViewLayout: flow)
        
        let navicon = UINavigationController(rootViewController: investigatorController)
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = "Investigator"
