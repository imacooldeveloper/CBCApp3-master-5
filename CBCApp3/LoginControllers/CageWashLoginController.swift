...
class CageWashLoginController: UIViewController {
...
//        guard let floor = floorNum.text, floor.count > 0 else { return }
        ...
        let cageWashController = CageWashController(collectionViewLayout: flow)
        let navicon = CustomNavigation(rootViewController: cageWashController)
